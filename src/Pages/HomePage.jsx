...
const HomePage = () => {
  return (
   ...
   <div className=" p-3 grid md:grid-cols-2 md:gap-10 -mb-12 z-10 relative">
    ...
    <div className=' w-80 md:w-[30rem] p-4'> 
     <img src='/renew.png' alt='phone item' className='w-56 md:w-[30rem] md:h-[40rem]' />
     </div>
